...
export default function RepertorioInstrumentosPage() {
  const columns = [
    ...
    { key: 'contratante_1_apellido', label: 'Apellido C1' },
    { key: 'contratante_1_nombre', label: 'Nombre C1' },
    { key: 'contratante_2_apellido', label: 'Apellido C2' },
  ...
  const searchFields = [
    ...
    { id: 'contratante_1_apellido', label: 'Apellido Contratante', type: 'text' },
  ...
  return (
    <main className="min-h-screen bg-slate-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <RepertorioSearch
          tableName="repertorio_instrumentos_cesar_peinan"
