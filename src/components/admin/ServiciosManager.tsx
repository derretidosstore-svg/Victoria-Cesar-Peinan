    ...
    <>
      <section className="p-8 mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {/* Total */}
          <div 
            onClick={() => setFilterEstado(filterEstado === 'todos' ? 'todos' : 'todos')}
            className={`cursor-pointer bg-white p-5 rounded-xl shadow-sm border flex flex-col justify-between transition-all hover:scale-[1.01] hover:shadow-md ${filterEstado === 'todos' ? 'border-[#005ab4] ring-1 ring-[#005ab4]' : 'border-slate-100'}`}
          >
            ...
            <div className="mt-4">
              <p className="text-slate-500 text-xs font-semibold uppercase tracking-wider">Total Registrados</p>
          ...
          <div 
            ...
            className={`cursor-pointer bg-white p-5 rounded-xl shadow-sm border flex flex-col justify-between transition-all hover:scale-[1.01] hover:shadow-md ${filterEstado === 'activo' ? 'border-[#005ab4] ring-1 ring-[#005ab4]' : 'border-slate-100'}`}
          >
            <div className="flex justify-between items-start">
              <div className="p-2 rounded-lg bg-emerald-50 text-emerald-600">
                <span className="material-symbols-outlined text-[20px]">check_circle</span>
              </div>
              <span className="text-[10px] font-bold text-emerald-700 bg-emerald-50 border border-emerald-100 px-2.5 py-1 rounded-md uppercase tracking-tighter">Públicos</span>
            </div>
            <div className="mt-4">
              <p className="text-slate-500 text-xs font-semibold uppercase tracking-wider">Servicios Activos</p>
          ...
          <div 
            ...
            className={`cursor-pointer bg-white p-5 rounded-xl shadow-sm border flex flex-col justify-between transition-all hover:scale-[1.01] hover:shadow-md ${filterEstado === 'inactivo' ? 'border-[#005ab4] ring-1 ring-[#005ab4]' : 'border-slate-100'}`}
          >
            <div className="flex justify-between items-start">
              <div className="p-2 rounded-lg bg-red-50 text-red-600">
                <span className="material-symbols-outlined text-[20px]">visibility_off</span>
              </div>
              <span className="text-[10px] font-bold text-red-700 bg-red-50 border border-red-100 px-2.5 py-1 rounded-md uppercase tracking-tighter">Borradores</span>
            </div>
            <div className="mt-4">
              <p className="text-slate-500 text-xs font-semibold uppercase tracking-wider">Servicios Inactivos</p>
