...
const BuscadorService = {
    ...
    state: {
        currentTable: 'repertorio_instrumentos_cesar_peinan', // Tabla seleccionada para buscar
    ...
    init() {
        ...
        if (btnInst) {
            btnInst.addEventListener('click', () => this.switchTable('repertorio_instrumentos_cesar_peinan'));
    ...
    updateButtonStyles() {
        ...
        if (this.state.currentTable === 'repertorio_instrumentos_cesar_peinan') {
